...
function AdminNewProduct() {
  ...
  const [variants, setVariants] = useState([
    { size: "", colorName: "", colorHex: "#000000", stock: 1 },
  ]);
      ...
      <form onSubmit={handleSubmit} className="space-y-8">
        ...
        <section className="rounded-xl border border-zinc-200 bg-white p-6 shadow-sm">
          ...
          <input
            ...
            className="w-full rounded-lg border border-dashed border-zinc-300 p-8 text-center text-sm text-zinc-500 hover:bg-zinc-50"
          />
          {imageFiles.length > 0 && (
